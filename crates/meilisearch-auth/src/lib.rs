...
use maplit::hashset;
use meilisearch_types::heed::{Env, WithTls, WithoutTls}; // Add WithTls import
...
impl AuthController {
    pub fn new(auth_env: Env<WithTls>, master_key: &Option<String>) -> Result<Self> { // Change WithoutTls to WithTls
